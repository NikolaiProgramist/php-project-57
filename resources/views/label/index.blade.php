<x-app-layout>
    ...
    <div class="flex justify-center">
        <div class="mt-16 bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[75%] overflow-hidden transition-all duration-300 hover:shadow-3xl animate-fade-in">
            <div class="p-6">
                <div class="flex justify-between">
                    <div class="w-[90%] flex justify-between items-center text-left space-x-4 mb-2 p-3 rounded-lg">
                        ...
                        <div class="w-[61%]">
                            <h3 class="text-lg font-semibold text-indigo-800 dark:text-white">{{ __('Description') }}</h3>
                        </div>
                    ...
                    @foreach($labels as $label)
                        <div class="flex justify-between">
                            <div class="w-[90%] flex justify-between items-center text-left space-x-4 mb-2 p-3 bg-indigo-50 dark:bg-gray-700 rounded-lg transition-all duration-300 hover:bg-indigo-100 dark:hover:bg-gray-600">
                                <div class="w-[4%]">
                                    <p class="text-sm mt-1.5 text-gray-600 font-bold dark:text-gray-300">{{ $label->id }}</p>
                                </div>
                                <div class="w-[15%]">
                                    <h3 class="text-lg font-semibold text-indigo-800 dark:text-white">{{ $label->name }}</h3>
                                </div>
                                <div class="w-[61%]">
                                    <p class="text-sm mt-1.5 text-gray-600 font-bold dark:text-gray-300">{{ $label->description }}</p>
                                </div>
                                <div class="w-[16%] text-right">
                                    <p class="text-sm mt-1 text-gray-600 font-bold dark:text-gray-300">{{ Carbon\Carbon::createFromDate($label->created_at)->format('d.m.Y') }}</p>
                                </div>
                            </div>
