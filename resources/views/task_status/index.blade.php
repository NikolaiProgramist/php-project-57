                            ...
                            @auth()
                                <div class="flex w-[18%] h-auto items-center mb-2">
                                    <div class="flex justify-between">
                                        ...
                                        <a href="{{ route('task_statuses.destroy', $taskStatus) }}" data-confirm="Are you sure?" data-method="delete" rel="nofollow" class="w-[48%] inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
